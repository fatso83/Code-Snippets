...
/*
 * En viev metode bør ligge et annet sted.
 * Her bør det kanskje være get/set metoder for å jobbe med objekter
 * Kanskje en 
 * Customer *get_customer( string name )
 * I det hele tatt burde det vært en unik kundeid på hvert objekt.
 * f.eks. en "int customer_id". Søkte man på navn i et buffer skapt
 * av alle navnene kunne kundenavn[kundeid] har man en nøkkel->navn
 */
